...
export const Modal: React.FC<ModalProps> = ({
  ...
  const modalContent = (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 px-6 py-4 bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-md flex-shrink-0">
          <div>
        ...
        {/* Body */}
        <div className="px-6 py-5.5 overflow-y-auto flex-1">{children}</div>
      </div>
    </div>
  );
